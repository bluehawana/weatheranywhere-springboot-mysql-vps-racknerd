...
public class WeatherController {
    ...
    private String buildHtml(String city, WeatherInfo weatherInfo) {
        ...
        // Add weather ASCII art
        String weatherASCII = cityLandmarkService.getWeatherASCII(weatherInfo.getDescription());
        sb.append(weatherASCII);
        
        // Add landmark ASCII art
        String landmarkASCII = cityLandmarkService.getCityLandmarkASCII(city);
        sb.append(landmarkASCII);
